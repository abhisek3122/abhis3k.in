...
window.SITE = {
  // Browser tab title for the homepage (the name shown on the page itself
  // stays profile.name below).
  siteTitle: "abhisek aka. damnwhere",
  ...
  links: [
    { title: "Blog",            subtitle: "My technical writings",                  url: "blog/",                    external: false },
